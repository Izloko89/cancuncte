...
$registros_adeudos= mysql_query("SELECT id_movimiento, fecha, movimiento, cantidad
FROM  proveedores_movimientos 
 WHERE id_proveedor = $checa",$conexion)
or die("Problemas en el select:".mysql_error());
...
{
	echo "<tr>";
	    echo "<td bgcolor=\"#f2f2f2\" style=\"font-family: Tahoma, Geneva, sans-serif; text-align: center; font-weight: bold; font-size: 14px;\" >".$reg['id_movimiento']."</td>";
    echo "<td bgcolor=\"#f2f2f2\" style=\"font-family: Tahoma, Geneva, sans-serif; text-align: center; font-weight: bold; font-size: 14px;\" >".$reg['fecha']."</td>";
	    echo "<td bgcolor=\"#f2f2f2\" style=\"font-family: Tahoma, Geneva, sans-serif; text-align: center; font-weight: bold; font-size: 14px;\" >".$reg['movimiento']."</td>";
