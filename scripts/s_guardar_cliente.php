...
try{
	...
	$sql="insert into clientes(id_empresa, clave, nombre, compania, ncom,giro)values(1, '$clave', '$nombre', 'CTA', '$limitecredito', '$giro')";
	$bd->query($sql);
	...
	$bd->query($sql);
	$sql="insert into clientes_fiscal(id_empresa, id_cliente, rfc, razon, nombrecomercial, direccion, colonia, estado, cpf, ciudad)
	values(1, $id_cliente, '$rfcf', '$razonf', '$nombrecomercialf', '$direccionf', '$coloniaf', '$estadof', '$cpf', '$ciudadf')";
	$bd->query($sql);
	$r["continuar"] = true;
