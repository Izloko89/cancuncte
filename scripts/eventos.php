...
<div id="tabs">
	...
	<h3 class='titulo_form'>Observaciones</h3>
		...
		<input type="submit" onclick = "this.form.action = 'scripts/pdf_cotizacion.php'" value="" class="flota_der2" style="background:url(img/Mexico.png); width:36px; height:26px;background-repeat:
no-repeat; background-position: 50% 50%;"/>
	    <input type="submit" onclick = "this.form.action = 'scripts/pdf_cotizacion2.php'" value="" class="flota_der" style="background:url(img/USA.png); width:36px; height:26px; background-repeat:
no-repeat; background-position: 50% 50%;"/>
		</form>
	</div>
	</div>
