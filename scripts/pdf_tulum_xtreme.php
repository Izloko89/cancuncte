...
<td width="76%" style="width:65%;text-align:justify;  font-size:13px;">
    ...
    Fly 21 meters (70 feet) above the jungle canopy on 765 meters (2,525 ft) zip line ride! Test your tenacity as you rappel 21 meters (70 ft) down into the Mayan jungle. Afterwards, wind down and enjoy snorkeling through an underground cavern. Delight yourself by sampling real Mexican cuisine as a perfect finish.
        ...
        <tr>
            <td style="width:55%;">A/C Transportation, professional guides, entrance fees, climbing and snorkeling equipment, lunch and beverages, insurance and taxes.</td>
        </tr>
    </table>
        ...
        <tr>
            <td style="width:55%;">Guided tour at Tulum: 45 minutes plus 1 hour free time.</td>
        </tr>
        <tr>
            <td style="width:55%;">&nbsp;</td>
        </tr>
        <tr>
            <td style="width:55%;"><strong>Duration:</strong> Approximately 7 hours from pickup to drop off.</td>
        </tr>
    </table>
    <br/>
         <table border="0.5" cellpadding="0.5" cellspacing="0" style=" font-size:12px;width:100%;">
        ...
        <tr>
                <td style="width:20%;">Free time:</td>
                 <td style="width:20%;">11:00 A.M.-12:00 A.M.</td>
        </tr>
        <tr>
                <td style="width:20%;">Lunch:</td>
                 <td style="width:20%;">12:15 P.M.- 01:15 P.M.</td>
        </tr>
        <tr>
                <td style="width:20%;">Guided tour in Tulum:</td>
                 <td style="width:20%;">01:15 P.M-02:00 P.M.</td>
        </tr>
        <tr>
