      ...
      <div id="footer_arriba" class="fondo_gris linea_arriba_gris tabla">
        <div class="footer_contenido fila">
          ...
          <span class="link" data-url="home.php">Inicio</span>/
            ...
            <span class="link" data-url="eventos.php">Propuesta</span>/
            <span class="link" data-url="modulos.php">Módulos</span>
            <span class="link" data-url="scripts/logout.php">Cerrar Sesión</span>
          </div>
        </div>
      </div>
      <div id="footer_abajo" class="fondo_negro tabla">
        <div class="footer_contenido fila">
          <div class="celda centrado_v footer_color"> &copy; 2015 - Sistema desarrollado por Sandoval Tecnologías S.A. de C.V. - Todos los derechos reservados.</div>
        </div>
      </div>
    </div>
</div>
