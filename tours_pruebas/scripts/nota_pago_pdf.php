...
<table style="width:100%;border-bottom:<?php echo pxtomm(2); ?> solid #000;" cellpadding="0" cellspacing="0" >
    <tr>
		 <td valign="top" style="width:25%; text-align:left;"><img src="../img/logo.png" style="width:100%;" /></td>
         <td valign="top" style="width:50%; text-align:left;">         	
            <p style="width:100%; padding:4px; font-size:8px; margin:0; font-size:10px; text-align:center;">Grupo celebre<br />R.F.C. : CIIA 651504 J37</p>
         </td>
         <td valign="top" style="width:25%; text-align:left;">
         	<div style="width:100%; background-color:#E1E1E1; font-weight:bold; text-align:center; padding-top:5px; padding-bottom:5px;">RECIBO DE PAGO</div>
            <div style="width:100%; color:#C00; text-align:center;"><?php echo folio(5,$eve); ?></div>
         </td>
    </tr>
</table>

<p style="width:100%; text-align:center; margin:5px auto; font-size:8px;">Dirección</p>
...
<tr><td valign="top" style="width:75%;">
    <table cellpadding="0" cellspacing="0" style=" font-size:10px;width:100%; padding:10px; padding-top:5px; padding-bottom:5px; border::1px solid #000; border-radius:6px;">
        <tr>
            <td style="width:20%;">RECIBI DE:</td>
...
<tr><td valign="top" style="width:75%;">
    <table cellpadding="0" cellspacing="0" style=" font-size:10px;width:100%; padding:10px; padding-top:5px; padding-bottom:5px; border::1px solid #000; border-radius:6px;">
        <tr>
            ...
            <td style="width:80%;"><div style="margin-left:5px; border-bottom:1px solid #000;"><?php echo $total; ?></div></td>
        </tr><tr>
            <td style="width:20%;">POR CONCEPTO:</td>
            <td style="width:80%;"><div style="margin-left:5px; border-bottom:1px solid #000; font-size:8px;"><?php echo $evento; ?></div></td>
        </tr>
    </table>
</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" style="font-size:11px; width:100%; margin-top:5px;">
	<tr>
    	<td style="width:100%;vertical-align:top; text-align:center;">
        	ATENTAMENTE<br />Grupo celebre S. A.
        </td>
    </tr>
</table>
<?php }else{
