...
<div id="contenido">
        ...
        <div id="control_calendario" class="tabla" align="center">
         ...
         <!--<div id="filtro_tipo" class="celda">
              ...
              <label>Documento:</label><select id="tipo_proyecto"><option selected="selected">Selecciona</option>
                  <option value="ambos">Ambos</option>
                  <option value="cotizacion">Propuestas</option>
                  <option value="event">Eventos</option>
              </select>
              <label>Tipo:</label><select id="tipo_evento"><option selected="selected">Selecciona</option>
                  <option value="todos">Todos</option?php tipoEventosOpt(); ?>
              </select>
          </div>-->
