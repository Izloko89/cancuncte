...
$(document).ready(function(e) {
	...
	$(".guardar").click(function(e) {
		...
		$.ajax({
			...
			success: function(r){
				if(r){
					alerta("info","Cliente agregado exitosamente");
					$(".volover").click();
				}else{
					alerta("error",r.info);
				}
...
<form id="f_clientes_contacto" class="formularios">
  ...
  <input type="hidden" name="id_empresa" value="<?php echo $_SESSION["id_empresa"]; ?>" />
    <div class="campo_form">
        ...
        <input type="text" name="giro" id="giro" class="giro">
    </div>
    <div class="campo_form">
...
function ClaveCliente(){
	...
	$.ajax({
	  ...
	  success: function(r){
		...
		document.getElementById("giro").value = r[0].giro;
		...
		document.getElementById("rfcf").value = r[0].rfc;
		document.getElementById("razonf").value = r[0].razon;
		document.getElementById("nombre").value = r[0].nombre;
		document.getElementById("nombrecomercialf").value = r[0].nombrecomercial;
		document.getElementById("direccionf").value = r[0].direccion;
		document.getElementById("coloniaf").value = r[0].colonia;
		document.getElementById("ciudadf").value = r[0].ciudad;
		document.getElementById("estadof").value = r[0].estado;
