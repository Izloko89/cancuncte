...
table{
	...
	#imp_cot1
	{
		background: transparent url('img/USA.png') left center no-repeat;
		background-size: contain;
		width: 60px;
		height: 30px;
		display: inline-block;
...
<div id="tabs">
	...
	<?php } ?>
		...
		<div class="campo_form celda">
			...
			<input type="file" name="logo" class="logo text_largo" />
			</div>-->
			<!--
		...
		<div class="celda" style="">
			...
			<div class="campo_form">
			<label class="align_right" style="width:120px;">Fecha de terminación</label>
		...
		<div align="right">
			...
			<input type="button" class="guardar" value="CREAR" data-wrap="#hacer" data-accion="guardar" data-m="pivote" onclick="saveImage();"/>
	...
	<table id="articulos">
		<tr>
			<th class="agregar_empleado"><img src="img/mas.png" height="25" /></th>
		<th width="100">Cant.</th>
		<th width="250">Concepto</th>
